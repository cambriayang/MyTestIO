//
//  TestTypeDrawRectViewController.m
//  MyTestIO
//
//  Created by Yang Cambria on 2022/6/13.
//  Copyright © 2022 CambriaYang. All rights reserved.
//

#import "TestTypeDrawRectVC.h"

@interface MyDrawRectView : UIView
@end

@implementation MyDrawRectView
...
//    CGContextDrawPath(context, kCGPathStroke);
    ...
    // 绘制图片
    UIImage *image = [UIImage imageNamed:@"hammer"];
    ...
    [@"绘制文字" drawInRect:CGRectMake(180, 270, 150, 35) withAttributes:attriDict];
...
@interface TestTypeDrawRectVC ()

@end

@implementation TestTypeDrawRectVC
...
- (void)viewDidLayoutSubviews {
    MyDrawRectView *view=[MyDrawRectView new];
